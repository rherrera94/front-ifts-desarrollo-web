...
<section class="novedades">
    <section class="izq">
        <article>
             <h2 class="titulo-noticia"> Certificado COVID-19</h2>
             <img src={img1} alt="Imagen noticia"/>
             <p class="informacion-novedad"> Para poder volver a trabajar de manera presencial todos los trabajadores deberan
                 presentar en el área de recursos humanos el certificado de vacunación.
             </p>
        </article>
        <hr/>
        <article>
            <h2 class="titulo-noticia"> Cierre comedor por pandemia</h2>
            <img src={img2} alt="Imagen noticia"/>
            <p class="informacion-novedad"> Te recordamos que tanto el comedor y el acceso a la terraza del piso 8 
       ...
       <hr/>
       <article>
            <h2 class="titulo-noticia"> Curso sobre javascript</h2>
            <img src={img3} alt="Imagen noticia"/>
            <p class="informacion-novedad"> Se informa a todo el personal relacionado con el sector informatico que hemos firmado
    ...
    <section class="centro">
        <article>
            <h2 class="titulo-noticia">Utilización lactario</h2>
            <img src={img4}alt="Imagen noticia"/>
            <p class="informacion-novedad"> Con el regreso paulatino y programado a las oficinas, 
       ...
       <hr/>
       <article>
           <h2 class="titulo-noticia"> Capacitación vuelta a la presencialidad</h2>
           <img src={img5} alt="Imagen noticia"/>
           <p class="informacion-novedad"> Conocé en detalle el protocolo sanitario y cuáles son los cuidados y recomendaciones para que entre  
               todos podamos crear un ambiente seguro para el trabajo presencial.</p> 
      </article>
      <hr/>
      <article>
           <h2 class="titulo-noticia"> Guarda de bicicletas</h2>
           <img src={img6} alt="Imagen noticia"/>
          <p class="informacion-novedad"> A partir del lunes 6 de septiembre podés volver a solicitar tu espacio guarda
...
<aside>
        <h2 class="titulo-noticia">Información Importante</h2>

        <div class="novedades-aside"> 
